...
//  PDFLibrary
//
//  Created by Sun Jimmy on 16/06/2017.
...
/* Define to 1 if your `struct tm' has `tm_zone'. Deprecated, use
 952    `HAVE_STRUCT_TM_TM_ZONE' instead. */
...
#define MAGICKCORE_LIBRARY_PATH "/usr/local/lib/ImageMagick-7.0.6/"
#endif
...
#define MAGICKCORE_PACKAGE_STRING "ImageMagick 7.0.6-0"
#endif
...
#define MAGICKCORE_PACKAGE_VERSION "7.0.6-0"
#endif
...
#define MAGICKCORE_VERSION "7.0.6-0"
#endif
...
/* Define to `__inline__' or `__inline' if that's what the C compiler
 1580    calls it, or to nothing if 'inline' is not supported under any name.  */
#ifndef __cplusplus
/* #undef inline */
#endif
...
/* Define to the type of a signed integer type of width exactly 64 bits if
 1594    such a type exists and the standard includes do not define it. */
/* #undef int64_t */

/* Define to the type of a signed integer type of width exactly 8 bits if such
 1598    a type exists and the standard includes do not define it. */
/* #undef int8_t */
...
/* Define to the type of a signed integer type wide enough to hold a pointer,
 1606    if such a type exists, and if the system does not define it. */
/* #undef intptr_t */
...
/* Define to the equivalent of the C99 'restrict' keyword, or to
 1622    nothing if this is not supported.  Do not define if restrict is
 1623    supported directly.  */
#ifndef _magickcore_restrict
#define _magickcore_restrict __restrict
#endif
/* Work around a bug in Sun C++: it does not support _Restrict or
 1628    __restrict__, even though the corresponding Sun C compiler ends up with
 1629    "#define restrict _Restrict" or "#define restrict __restrict__" in the
 1630    previous line.  Perhaps some future version of Sun C++ will work with
 1631    restrict; if so, hopefully it defines __RESTRICT like Sun C does.  */
...
/* Define to the type of an unsigned integer type of width exactly 16 bits if
 1647    such a type exists and the standard includes do not define it. */
/* #undef uint16_t */

/* Define to the type of an unsigned integer type of width exactly 32 bits if
 1651    such a type exists and the standard includes do not define it. */
/* #undef uint32_t */

/* Define to the type of an unsigned integer type of width exactly 64 bits if
 1655    such a type exists and the standard includes do not define it. */
/* #undef uint64_t */
...
/* Define to the type of an unsigned integer type wide enough to hold a
 1667    pointer, if such a type exists, and if the system does not define it. */
/* #undef uintptr_t */
...
/* Define to empty if the keyword `volatile' does not work. Warning: valid
 1674    code using `volatile' can become incorrect without. Disable with care. */
/* #undef volatile */
